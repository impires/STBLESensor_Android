...
public abstract class Hilt_ActivityRecognitionFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ActivityRecognitionFragment() {
    super();
  }

  Hilt_ActivityRecognitionFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ActivityRecognitionFragment_GeneratedInjector) this.generatedComponent()).injectActivityRecognitionFragment(UnsafeCasts.<ActivityRecognitionFragment>unsafeCast(this));
    }
  }
