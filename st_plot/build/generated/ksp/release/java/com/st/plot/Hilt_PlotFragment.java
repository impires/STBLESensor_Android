...
public abstract class Hilt_PlotFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PlotFragment_GeneratedInjector) this.generatedComponent()).injectPlotFragment(UnsafeCasts.<PlotFragment>unsafeCast(this));
    }
  }
