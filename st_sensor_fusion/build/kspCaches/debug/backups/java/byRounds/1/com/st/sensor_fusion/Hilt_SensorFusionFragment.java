...
public abstract class Hilt_SensorFusionFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SensorFusionFragment() {
    super();
  }

  Hilt_SensorFusionFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SensorFusionFragment_GeneratedInjector) this.generatedComponent()).injectSensorFusionFragment(UnsafeCasts.<SensorFusionFragment>unsafeCast(this));
    }
  }
