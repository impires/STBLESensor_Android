...
public abstract class Hilt_TofObjectsDetectionFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TofObjectsDetectionFragment() {
    super();
  }

  Hilt_TofObjectsDetectionFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TofObjectsDetectionFragment_GeneratedInjector) this.generatedComponent()).injectTofObjectsDetectionFragment(UnsafeCasts.<TofObjectsDetectionFragment>unsafeCast(this));
    }
  }
