...
public abstract class Hilt_MemsGestureFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MemsGestureFragment() {
    super();
  }

  Hilt_MemsGestureFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MemsGestureFragment_GeneratedInjector) this.generatedComponent()).injectMemsGestureFragment(UnsafeCasts.<MemsGestureFragment>unsafeCast(this));
    }
  }
