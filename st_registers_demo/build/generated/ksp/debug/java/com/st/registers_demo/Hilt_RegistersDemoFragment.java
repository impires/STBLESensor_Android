...
public abstract class Hilt_RegistersDemoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RegistersDemoFragment() {
    super();
  }

  Hilt_RegistersDemoFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RegistersDemoFragment_GeneratedInjector) this.generatedComponent()).injectRegistersDemoFragment(UnsafeCasts.<RegistersDemoFragment>unsafeCast(this));
    }
  }
