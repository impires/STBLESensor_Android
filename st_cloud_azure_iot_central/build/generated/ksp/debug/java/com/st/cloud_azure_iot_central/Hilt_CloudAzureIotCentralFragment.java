...
public abstract class Hilt_CloudAzureIotCentralFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CloudAzureIotCentralFragment() {
    super();
  }

  Hilt_CloudAzureIotCentralFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CloudAzureIotCentralFragment_GeneratedInjector) this.generatedComponent()).injectCloudAzureIotCentralFragment(UnsafeCasts.<CloudAzureIotCentralFragment>unsafeCast(this));
    }
  }
