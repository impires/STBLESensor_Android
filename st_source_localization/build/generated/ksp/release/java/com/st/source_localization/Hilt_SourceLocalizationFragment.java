...
public abstract class Hilt_SourceLocalizationFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SourceLocalizationFragment() {
    super();
  }

  Hilt_SourceLocalizationFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SourceLocalizationFragment_GeneratedInjector) this.generatedComponent()).injectSourceLocalizationFragment(UnsafeCasts.<SourceLocalizationFragment>unsafeCast(this));
    }
  }
