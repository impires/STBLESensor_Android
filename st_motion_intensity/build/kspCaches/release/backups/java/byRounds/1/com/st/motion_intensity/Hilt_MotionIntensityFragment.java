...
public abstract class Hilt_MotionIntensityFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MotionIntensityFragment() {
    super();
  }

  Hilt_MotionIntensityFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MotionIntensityFragment_GeneratedInjector) this.generatedComponent()).injectMotionIntensityFragment(UnsafeCasts.<MotionIntensityFragment>unsafeCast(this));
    }
  }
