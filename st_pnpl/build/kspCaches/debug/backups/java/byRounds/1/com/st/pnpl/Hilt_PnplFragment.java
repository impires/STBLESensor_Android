...
public abstract class Hilt_PnplFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PnplFragment_GeneratedInjector) this.generatedComponent()).injectPnplFragment(UnsafeCasts.<PnplFragment>unsafeCast(this));
    }
  }
