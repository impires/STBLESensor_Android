...
public abstract class Hilt_HeartRateDemoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_HeartRateDemoFragment() {
    super();
  }

  Hilt_HeartRateDemoFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HeartRateDemoFragment_GeneratedInjector) this.generatedComponent()).injectHeartRateDemoFragment(UnsafeCasts.<HeartRateDemoFragment>unsafeCast(this));
    }
  }
