...
public abstract class Hilt_RawPnplFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RawPnplFragment() {
    super();
  }

  Hilt_RawPnplFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RawPnplFragment_GeneratedInjector) this.generatedComponent()).injectRawPnplFragment(UnsafeCasts.<RawPnplFragment>unsafeCast(this));
    }
  }
