...
public abstract class Hilt_AccelerationEventFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AccelerationEventFragment() {
    super();
  }

  Hilt_AccelerationEventFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AccelerationEventFragment_GeneratedInjector) this.generatedComponent()).injectAccelerationEventFragment(UnsafeCasts.<AccelerationEventFragment>unsafeCast(this));
    }
  }
