...
public abstract class Hilt_SwitchDemoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SwitchDemoFragment() {
    super();
  }

  Hilt_SwitchDemoFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SwitchDemoFragment_GeneratedInjector) this.generatedComponent()).injectSwitchDemoFragment(UnsafeCasts.<SwitchDemoFragment>unsafeCast(this));
    }
  }
