...
public abstract class Hilt_MultiNeuralNetworkFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MultiNeuralNetworkFragment() {
    super();
  }

  Hilt_MultiNeuralNetworkFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MultiNeuralNetworkFragment_GeneratedInjector) this.generatedComponent()).injectMultiNeuralNetworkFragment(UnsafeCasts.<MultiNeuralNetworkFragment>unsafeCast(this));
    }
  }
