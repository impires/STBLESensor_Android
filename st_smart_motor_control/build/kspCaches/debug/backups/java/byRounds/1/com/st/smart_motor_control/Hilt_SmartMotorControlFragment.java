...
public abstract class Hilt_SmartMotorControlFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SmartMotorControlFragment() {
    super();
  }

  Hilt_SmartMotorControlFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SmartMotorControlFragment_GeneratedInjector) this.generatedComponent()).injectSmartMotorControlFragment(UnsafeCasts.<SmartMotorControlFragment>unsafeCast(this));
    }
  }
