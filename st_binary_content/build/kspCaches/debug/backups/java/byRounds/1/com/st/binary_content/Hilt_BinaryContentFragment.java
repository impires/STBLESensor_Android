...
public abstract class Hilt_BinaryContentFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BinaryContentFragment() {
    super();
  }

  Hilt_BinaryContentFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BinaryContentFragment_GeneratedInjector) this.generatedComponent()).injectBinaryContentFragment(UnsafeCasts.<BinaryContentFragment>unsafeCast(this));
    }
  }
