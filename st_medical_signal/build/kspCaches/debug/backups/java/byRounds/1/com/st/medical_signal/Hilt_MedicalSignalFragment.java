...
public abstract class Hilt_MedicalSignalFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MedicalSignalFragment() {
    super();
  }

  Hilt_MedicalSignalFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MedicalSignalFragment_GeneratedInjector) this.generatedComponent()).injectMedicalSignalFragment(UnsafeCasts.<MedicalSignalFragment>unsafeCast(this));
    }
  }
