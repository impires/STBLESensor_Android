...
public abstract class Hilt_ProximityGestureRecognitionFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProximityGestureRecognitionFragment() {
    super();
  }

  Hilt_ProximityGestureRecognitionFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProximityGestureRecognitionFragment_GeneratedInjector) this.generatedComponent()).injectProximityGestureRecognitionFragment(UnsafeCasts.<ProximityGestureRecognitionFragment>unsafeCast(this));
    }
  }
