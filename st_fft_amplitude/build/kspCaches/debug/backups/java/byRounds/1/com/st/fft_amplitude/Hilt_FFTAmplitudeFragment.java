...
public abstract class Hilt_FFTAmplitudeFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FFTAmplitudeFragment() {
    super();
  }

  Hilt_FFTAmplitudeFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FFTAmplitudeFragment_GeneratedInjector) this.generatedComponent()).injectFFTAmplitudeFragment(UnsafeCasts.<FFTAmplitudeFragment>unsafeCast(this));
    }
  }
