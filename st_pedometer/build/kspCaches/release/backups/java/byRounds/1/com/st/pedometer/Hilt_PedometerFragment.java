...
public abstract class Hilt_PedometerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PedometerFragment() {
    super();
  }

  Hilt_PedometerFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PedometerFragment_GeneratedInjector) this.generatedComponent()).injectPedometerFragment(UnsafeCasts.<PedometerFragment>unsafeCast(this));
    }
  }
