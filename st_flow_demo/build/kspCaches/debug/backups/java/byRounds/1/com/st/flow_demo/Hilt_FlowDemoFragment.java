...
public abstract class Hilt_FlowDemoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FlowDemoFragment() {
    super();
  }

  Hilt_FlowDemoFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FlowDemoFragment_GeneratedInjector) this.generatedComponent()).injectFlowDemoFragment(UnsafeCasts.<FlowDemoFragment>unsafeCast(this));
    }
  }
