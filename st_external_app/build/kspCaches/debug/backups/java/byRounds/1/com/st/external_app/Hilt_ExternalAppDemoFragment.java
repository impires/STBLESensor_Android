...
public abstract class Hilt_ExternalAppDemoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ExternalAppDemoFragment() {
    super();
  }

  Hilt_ExternalAppDemoFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ExternalAppDemoFragment_GeneratedInjector) this.generatedComponent()).injectExternalAppDemoFragment(UnsafeCasts.<ExternalAppDemoFragment>unsafeCast(this));
    }
  }
