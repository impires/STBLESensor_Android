...
public abstract class Hilt_NfcWritingFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NfcWritingFragment() {
    super();
  }

  Hilt_NfcWritingFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NfcWritingFragment_GeneratedInjector) this.generatedComponent()).injectNfcWritingFragment(UnsafeCasts.<NfcWritingFragment>unsafeCast(this));
    }
  }
