...
public abstract class Hilt_TextualMonitorFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TextualMonitorFragment() {
    super();
  }

  Hilt_TextualMonitorFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TextualMonitorFragment_GeneratedInjector) this.generatedComponent()).injectTextualMonitorFragment(UnsafeCasts.<TextualMonitorFragment>unsafeCast(this));
    }
  }
