...
public abstract class Hilt_AudioClassificationDemoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AudioClassificationDemoFragment() {
    super();
  }

  Hilt_AudioClassificationDemoFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AudioClassificationDemoFragment_GeneratedInjector) this.generatedComponent()).injectAudioClassificationDemoFragment(UnsafeCasts.<AudioClassificationDemoFragment>unsafeCast(this));
    }
  }
