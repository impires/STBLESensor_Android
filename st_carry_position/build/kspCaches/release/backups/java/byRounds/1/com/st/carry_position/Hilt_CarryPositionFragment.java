...
public abstract class Hilt_CarryPositionFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CarryPositionFragment() {
    super();
  }

  Hilt_CarryPositionFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CarryPositionFragment_GeneratedInjector) this.generatedComponent()).injectCarryPositionFragment(UnsafeCasts.<CarryPositionFragment>unsafeCast(this));
    }
  }
