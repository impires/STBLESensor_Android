...
public abstract class Hilt_PredictedMaintenanceFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PredictedMaintenanceFragment() {
    super();
  }

  Hilt_PredictedMaintenanceFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PredictedMaintenanceFragment_GeneratedInjector) this.generatedComponent()).injectPredictedMaintenanceFragment(UnsafeCasts.<PredictedMaintenanceFragment>unsafeCast(this));
    }
  }
