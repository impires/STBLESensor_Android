...
public abstract class Hilt_CloudMqttFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CloudMqttFragment() {
    super();
  }

  Hilt_CloudMqttFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CloudMqttFragment_GeneratedInjector) this.generatedComponent()).injectCloudMqttFragment(UnsafeCasts.<CloudMqttFragment>unsafeCast(this));
    }
  }
