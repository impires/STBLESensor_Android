...
public abstract class Hilt_MotionAlgorithmsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MotionAlgorithmsFragment() {
    super();
  }

  Hilt_MotionAlgorithmsFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MotionAlgorithmsFragment_GeneratedInjector) this.generatedComponent()).injectMotionAlgorithmsFragment(UnsafeCasts.<MotionAlgorithmsFragment>unsafeCast(this));
    }
  }
