...
public abstract class Hilt_LedControlFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LedControlFragment() {
    super();
  }

  Hilt_LedControlFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LedControlFragment_GeneratedInjector) this.generatedComponent()).injectLedControlFragment(UnsafeCasts.<LedControlFragment>unsafeCast(this));
    }
  }
