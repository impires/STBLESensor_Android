...
public abstract class Hilt_GnssFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GnssFragment_GeneratedInjector) this.generatedComponent()).injectGnssFragment(UnsafeCasts.<GnssFragment>unsafeCast(this));
    }
  }
