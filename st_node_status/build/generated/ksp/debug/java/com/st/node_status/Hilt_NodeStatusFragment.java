...
public abstract class Hilt_NodeStatusFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NodeStatusFragment() {
    super();
  }

  Hilt_NodeStatusFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NodeStatusFragment_GeneratedInjector) this.generatedComponent()).injectNodeStatusFragment(UnsafeCasts.<NodeStatusFragment>unsafeCast(this));
    }
  }
