...
public abstract class Hilt_NeaiExtrapolationFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NeaiExtrapolationFragment() {
    super();
  }

  Hilt_NeaiExtrapolationFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NeaiExtrapolationFragment_GeneratedInjector) this.generatedComponent()).injectNeaiExtrapolationFragment(UnsafeCasts.<NeaiExtrapolationFragment>unsafeCast(this));
    }
  }
