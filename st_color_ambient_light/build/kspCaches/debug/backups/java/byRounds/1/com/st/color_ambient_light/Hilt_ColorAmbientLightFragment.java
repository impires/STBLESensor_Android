...
public abstract class Hilt_ColorAmbientLightFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ColorAmbientLightFragment() {
    super();
  }

  Hilt_ColorAmbientLightFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ColorAmbientLightFragment_GeneratedInjector) this.generatedComponent()).injectColorAmbientLightFragment(UnsafeCasts.<ColorAmbientLightFragment>unsafeCast(this));
    }
  }
