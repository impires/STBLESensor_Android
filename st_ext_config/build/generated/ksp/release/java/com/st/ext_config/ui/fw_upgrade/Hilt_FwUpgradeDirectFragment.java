...
public abstract class Hilt_FwUpgradeDirectFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FwUpgradeDirectFragment() {
    super();
  }

  Hilt_FwUpgradeDirectFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FwUpgradeDirectFragment_GeneratedInjector) this.generatedComponent()).injectFwUpgradeDirectFragment(UnsafeCasts.<FwUpgradeDirectFragment>unsafeCast(this));
    }
  }
