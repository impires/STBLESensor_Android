...
public abstract class Hilt_ExtConfigFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ExtConfigFragment() {
    super();
  }

  Hilt_ExtConfigFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ExtConfigFragment_GeneratedInjector) this.generatedComponent()).injectExtConfigFragment(UnsafeCasts.<ExtConfigFragment>unsafeCast(this));
    }
  }
