...
public abstract class Hilt_CertRequestFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CertRequestFragment() {
    super();
  }

  Hilt_CertRequestFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CertRequestFragment_GeneratedInjector) this.generatedComponent()).injectCertRequestFragment(UnsafeCasts.<CertRequestFragment>unsafeCast(this));
    }
  }
